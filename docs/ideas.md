...
friend in their L1 (e.g., _embaraçada_ ≠ Spanish _embarazada_),
...
Add `forms` table (surface forms of lemmas — _falo_, _falas_,
_falando_ all roll up to _falar_) and `senses` table (polysemy —
_banco_ bank vs _banco_ bench).
...
- This is the _defining_ feature in apps like LingQ, Migaku, Lute.
...
phoneme tricky for the user's L1. Example: "the _r_ in this word
is an English _h_ sound."
